...
const I18N = {
  en: {
    ...
    "agent.archHQname": "Back-office",
    "agent.archHQtag": "Strategy & Planning",
    "agent.archHQroles": "Product Ops → Sales Ops",
    "agent.archHQdesc": "In the top-down system, the back-office is the 'planner': product ops shapes ad strategy and product mix; sales ops decomposes targets into executable tasks, runs target forecasting & incentive distribution, and steers the business via multi-dimensional analytics. Multi-Agent systems here drive the closed loop of target incentive, task decomposition, incentive distribution and performance analytics.",
    "agent.archCityName": "Frontline",
    "agent.archCityTag": "Region Operation",
    "agent.archCityRoles": "Ad Business Mgr → Region Mgr",
    "agent.archCityDesc": "The frontline is the 'translator': ad business managers convert back-office strategy into region-level sales cadence and resource allocation; region managers localize strategy to cities and channels, handling target decomposition, city adaptation and execution monitoring. Multi-Agent systems here deliver regional diagnostics, pacing recommendations and strategy adaptation.",
    "agent.archSalesName": "Channel",
    "agent.archSalesTag": "Frontline Execution",
    "agent.archSalesRoles": "Tier-1 Partner → City Lead → BD / Ops",
    "agent.archSalesDesc": "The channel is the 'executor' that actually touches merchants: tier-1 partners cascade targets to cities; city leads translate them into concrete BD / ops actions (promotion, ad setup, follow-up); execution feedback flows back in real time. Multi-Agent systems here deliver merchant profiling, ad-setup recommendations and strategy matching so every front-line action is data-backed and measurable.",
